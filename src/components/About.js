...
export default function About(props) {
    ...
    let myStyle = {
        ...
        backgroundColor : props.mode === "dark"?"#006494": "white",
    }
        ...
        <div className="accordion" id="accordionExample" style={myStyle}>
            <div className="accordion-item">
                ...
                <div className="accordion-body"  style={myStyle}>
                    Textutils gives you a way to analyze your text quickly and effeciently. Be it word count, character count or
                </div>
                </div>
            </div>
            <div className="accordion-item">
